-- Fix the content type mismatch in the handle_content_vectorization function
-- The function is using 'description' and 'figure' but the constraint expects 'research_description' and 'scientific_figure'
